...
export default function Games() {
    ...
    async function fetchData(pageIndex, pageSize) {
        try {
            ...
            const games = await getAllGames(pageIndex, pageSize);
    ...
    return (
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                <ItemSection addToBasket = {addToBasket} title='top selling games' url="#" itemlist={ topGames }/>
                <ItemSectionPaginated addToBasket = {addToBasket} title='all games' itemlist={games} pageIndex={pageIndex} setPageIndex={setPageIndex}/>
            </main>
